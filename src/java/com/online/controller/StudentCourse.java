...
public class StudentCourse extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         String course=(String)request.getAttribute("studentcourse");
         ...
         request.getRequestDispatcher("AccountantHeader.html").include(request, response);
            ...
            List<StudentBeans> list=ViewStudentName.getAllRecordsByCourse(course);
            
           if(list.isEmpty())
            {
        request.setAttribute("StudentError", "2");
