 ...
 * @author vipin
 */
@WebServlet(name = "AccountantSalary", urlPatterns = {"/AccountantSalary"})
public class AccountantSalary extends HttpServlet {
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         String sal=(String)request.getAttribute("accountantsalary");
         ...
         request.getRequestDispatcher("AdminHeader.html").include(request, response);
            ...
            List<AccountantBeans> list=ViewAccountant.getRecordsBySalary(salary);
            
           if(list.isEmpty())
            {
        request.setAttribute("AccountantError", "3");
